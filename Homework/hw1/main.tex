...
\begin{solution}
	\begin{proof}
		...
		in particular \S2.2 of the course notes.
...
\begin{enumerate}[label=(\alph*)]
	\item $K$ is an injective $R$-module. \hfill (5)
	      \begin{solution}
		      ...
		      By Baer's criterion (Theorem~2.8 in the course notes),
	...
	\item $K$ is a projective $R$-module. \hfill (5)
	      \begin{solution}
		      ...
		      free (Corollary~3.4 in the course notes). Thus
		      \[
	...
	\item The short exact sequence of $R$-modules
	      ...
	      \begin{solution}
		      ...
		      \]
		      By Proposition~2.2 in the course notes, split exactness
	...
	\item A module $M$ is torsion if and only if $M \otimes_R K = 0$. \hfill (10)
	      \begin{solution}
		      ...
		      \S3.1 of the course notes. We have
		      \[
...
\begin{enumerate}[label=(\alph*)]
	...
	\item $\mathbb{Z}/4 \otimes_{\mathbb{Z}} \mathbb{Z}/16$ \hfill (5)
	      \begin{solution}
		      Use the canonical identity from the Week 4 tensor-product section
		      of the course notes,
		      \[
	...
	\item Show that $A_{\mathrm{tors}}$ is a direct summand of $A$. \hfill (10)
	      \begin{solution}
		      ...
		      \[
			      A_{\mathrm{tors}}=\mathbb Q/\mathbb Z.
		      \]
		      Since $\mathbb Z$ is a PID, Theorem~3.5 in the course notes gives
		      \[
